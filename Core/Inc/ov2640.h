...
#include "stm32h7xx_hal.h" // HAL 함수 사용용

/* ST BSP Camera Resolution Constants */
#define CAMERA_R160x120                 0x00
#define CAMERA_R320x240                 0x01
#define CAMERA_R480x272                 0x02
#define CAMERA_R640x480                 0x03

/* ST BSP Camera Feature Constants */
#define CAMERA_BLACK_WHITE              0x00
...
#define CAMERA_CONTRAST_BRIGHTNESS      0x01
...
#define CAMERA_COLOR_EFFECT             0x02
#define CAMERA_COLOR_EFFECT_ANTIQUE     0x00
